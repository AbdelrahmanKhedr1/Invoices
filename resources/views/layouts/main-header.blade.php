    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/home') }}"><img src="{{ URL::asset('assets/img/brand/logo.png') }}" class="logo-1"
                        alt="logo"></a>
                <a href="{{ url('/home') }}"><img src="{{ URL::asset('assets/img/brand/logo-white.png') }}"
                        class="dark-logo-1" alt="logo"></a>
                <a href="{{ url('/home') }}"><img src="{{ URL::asset('assets/img/brand/favicon.png') }}" class="logo-2"
                        alt="logo"></a>
                <a href="{{ url('/home') }}"><img src="{{ URL::asset('assets/img/brand/favicon.png') }}"
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-message ">
                    ...
                    <div class="dropdown nav-item main-header-notification"  id="notifications">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="main-notification-list Notification-scroll">
                                @foreach (Auth::user()->unreadnotifications as $notification)
                                    <a href="{{ route('invoices.notifi', $notification->id) }}">

                                        <span class="badge badge-pill badge-warning my-4 float-right">Delete</span>
                                    </a>
                                    <a class="d-flex p-2 border-bottom"
                                        href="{{ route('invoices.show', $notification->data['invoice_id']) }}">
                                        <div class="">
                                            <h5 class="notification-label mb-1">new invoice by :
                                                {{ $notification->data['creater'] }} </h5>
                                            <div class="notification-subtext">Invoices Nember:
                                                {{ $notification->data['invoice_number'] }}</div>
                                            <div class="notification-subtext">
                                                {{ date('d/m -  H:i', strtotime($notification->created_at)) }}</div>
                                        </div>
                                    </a>
                                @endforeach
                            ...
                            <div class="dropdown-footer">
                                <a href="{{ route('invoices.readall') }}">Mark All Read</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/faces/profile.png') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('assets/img/faces/profile.png') }}" class=""></div>
