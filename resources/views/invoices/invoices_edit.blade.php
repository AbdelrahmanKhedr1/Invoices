    ...
    <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="mg-b-20">Edit Invoice {{ $invoice->invoice_number }}</p>
                ...
                <form action="{{ route('invoices.update',$invoice) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{-- <p class="form-control">{{ $invoice->invoice_number }}</p> --}}
                    ...
                    <div class="row row-sm  ">
                        ...
                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                            ...
                            <select name="section_id" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                <option label="Choose one" value="{{ $invoice->section->id }}">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" placeholder="Invoice number"
                                name="amount_collection" value="{{ $invoice->amount_collection }}">
                    ...
                    <div class="row row-sm">
                        <div class="col-lg mg-t-10 mg-lg-t-0">
                            ...
                            <input class="form-control" placeholder="Value_VAT" readonly type="text"
                                id="Value_VAT" name="value_vat" value="{{ $invoice->value_vat }}">
                            @error('value_vat')
                                <div class="alert alert-danger">
                                    <p>{{ $message }}</p>
                                </div>
                    ...
                    <div class="row row-sm">
                        <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                            ...
                            <select class="form-control select2" id="Rate_VAT" name="rate_vat" onchange="myFunction()">
                    ...
                    <div class="row row-sm">
                        <div class="col-lg">
                            <textarea class="form-control" placeholder="Textarea" rows="3" name="note">{{ $invoice->note }}</textarea>
                        </div>
                    </div>
                    <br>
                    @can('add file')
                    ...
                    <div class="row row-sm">
                        <div class="col-sm-12 ">
                            ...
                            <a href="{{Storage::url($invoice->file)}}">

                                @if (!empty($invoice->file))
                                <img src="{{Storage::url($invoice->file)}}" style="width: 400px"><br><br>

                                @endif
                            <img src="{{Storage::url($invoice->file)}}" style="width: 300px">
                        </a>
                        </div>
                    </div>
                    @endcan
